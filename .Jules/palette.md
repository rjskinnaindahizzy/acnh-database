...
## 2026-01-28 - [Accessible Decorative Icons]
**Learning:** Decorative Unicode characters in buttons (like ↻, 📋, ✕) are often announced by screen readers, creating unnecessary noise. Additionally, embedded SVGs provide better cross-platform visual consistency compared to text-based Unicode icons.
**Action:** Always wrap decorative Unicode characters in `<span aria-hidden="true">` or replace them with embedded SVGs containing `aria-hidden="true"` to improve accessibility and visual consistency.
