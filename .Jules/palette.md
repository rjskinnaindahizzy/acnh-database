...
## 2026-01-28 - [Text Truncation Strategy]
**Learning:** Long text in data tables often gets truncated, hiding valuable information. Relying solely on tooltips or expansion clicks can be tedious for users scanning data.
**Action:** Provide a global "Wrap Text" toggle to allow users to switch between scannability (compact rows) and readability (full content) based on their current task.
