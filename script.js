    ...
    sheetLoadPromises[sheetName] = (async () => {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            headers.forEach((header, index) => {
                ...
                rowData[header] = isImageHeader(header) ? resolveImageUrl(value) : value;
            });
    ...
    if (isMultiSheet) {
        ...
        paginatedData.forEach(row => {
            ...
            headers.forEach(header => {
                ...
                const resolvedImageUrl = isImageHeader(header) ? resolveImageUrl(value) : '';
                if (isImageHeader(header) && resolvedImageUrl) {
